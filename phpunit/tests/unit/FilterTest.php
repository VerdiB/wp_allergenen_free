...
require_once '/var/www/html/wp-content/plugins/allergens-dietary/php/filter.php';
...
final class FilterTest extends TestCase
{
    ...
    {
        $this->assertTrue(class_exists('Allergens_Dietary_Filter'));
    }

    public function test_create_filter_method_exists()
    {
        $this->assertTrue(method_exists('Allergens_Dietary_Filter', 'create_filter'));
    }

    public function test_create_filter_is_public()
    {
        $reflector = new ReflectionClass('Allergens_Dietary_Filter');
    ...
    {
        $this->assertTrue(method_exists('Allergens_Dietary_Filter', 'filter_query'));
    }
