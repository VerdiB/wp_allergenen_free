...
require_once '/var/www/html/wp-content/plugins/allergens-dietary-ictoria/php/products.php';
 ...
 class ProductsTest extends TestCase
 {
    ...
    {
        $this->assertTrue(class_exists('Allergens_Dietary_Products'));
    }

    public function test_construct_is_private()
    {
        $reflector = new ReflectionClass('Allergens_Dietary_Products');
    ...
    {
        $this->assertTrue(method_exists('Allergens_Dietary_Products', 'render_html'));
    }
    ...
    {
        $this->assertTrue(method_exists('Allergens_Dietary_Products', 'show_product_options'));
    }
